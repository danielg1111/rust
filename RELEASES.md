...
- [Many more functions are marked `#[must_use]`][89692]
  <!-- NOTE: that must_use issue tracked additions to both 1.57 and 1.58,
       but it seems probably not worth it to list the individual PRs. -->
...
- [Stabilize named profiles][cargo/9943]
...
[87064]: https://github.com/rust-lang/rust/pull/87064/
